...
void registerAggregateFunctionsQuantileBFloat16WeightedBuckets(AggregateFunctionFactory &);
...
{
    {
        ...
        registerAggregateFunctionsQuantileBFloat16WeightedBuckets(factory);
